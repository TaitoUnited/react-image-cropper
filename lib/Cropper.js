...
var Cropper = (function (_Component) {
  ...
  _createClass(Cropper, [{
    ...
    value: function render () {
      ...
      var crossOrigin = this.props.crossOrigin || null
      ...
      return React.createElement(
        ...
        imgLoaded ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('span', {
              style: deepExtend({}, styles.gridLine, styles.lineMN)
            }),
            React.createElement('span', {
              style: deepExtend({}, styles.gridLine, styles.lineMS)
            }),
            React.createElement('span', {
              style: deepExtend({}, styles.gridLine, styles.lineMW)
            }),
            React.createElement('span', {
              style: deepExtend({}, styles.gridLine, styles.lineME)
            })
          )
        ) : null
      )
