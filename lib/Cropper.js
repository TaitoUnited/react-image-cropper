  ...
  _createClass(Cropper, [{
    ...
    value: function render() {
      ...
      var _props6 = this.props,
          ...
          crossOrigin = _props6.crossOrigin;
      ...
      return React.createElement(
        ...
        imgLoaded ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('span', { style: deepExtend({}, styles.gridLine, styles.lineMS) }),
            React.createElement('span', { style: deepExtend({}, styles.gridLine, styles.lineMN) }),
            React.createElement('span', { style: deepExtend({}, styles.gridLine, styles.lineME) }),
            React.createElement('span', { style: deepExtend({}, styles.gridLine, styles.lineMW) })
          )
        ) : null
      );
    }
